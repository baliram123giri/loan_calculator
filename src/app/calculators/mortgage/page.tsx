                ...
                <div className="max-w-4xl mx-auto mt-16 space-y-12">
                    ...
                    <section className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
                        ...
                        <p className="text-gray-700 dark:text-gray-300 mb-6">
                            Plan your home purchase with our complete suite of calculators:
                        </p>
                        <div className="grid md:grid-cols-3 gap-4">
                            ...
                            >
                                ...
                                <p className="text-sm text-gray-600 dark:text-gray-400">Estimate your annual property taxes</p>
                            </a>
                            <a
                            ...
                            >
                                ...
                                <p className="text-sm text-gray-600 dark:text-gray-400">Compare renting vs buying a home</p>
                            </a>
                        </div>
                    </section>
                </div>
