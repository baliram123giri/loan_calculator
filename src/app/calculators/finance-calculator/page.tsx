                ...
                <div className="mb-8">
                    <div className="text-center max-w-3xl mx-auto mb-12">
                        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-6 tracking-tight">
                            Advanced Finance <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Calculator</span>
                        </h1>
                        <p className="text-xl text-gray-600 dark:text-gray-400 leading-relaxed">
                            Master your money with our comprehensive Time Value of Money (TVM) calculator. Calculate Future Value, Present Value, Payments, and more.
                        </p>
                    </div>
                </div>
                ...
                <div className="max-w-4xl mx-auto mt-16 space-y-12">
                    ...
                    <section className="prose dark:prose-invert max-w-none">
                        <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
                            <span>⏱️</span> Understanding Time Value of Money (TVM)
                        </h2>
                    ...
                    <section className="bg-blue-50 dark:bg-blue-900/10 rounded-2xl p-8 border border-blue-100 dark:border-blue-800">
                        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
                            <span>🧮</span> The Five TVM Calculations Explained
                        </h3>
                    ...
                    <section className="prose dark:prose-invert max-w-none">
                        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                            <span>🔄</span> Understanding Compounding Frequency
                        </h3>
                    ...
                    <section className="bg-green-50 dark:bg-green-900/10 rounded-2xl p-8 border border-green-100 dark:border-green-800">
                        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
                            <span>📅</span> Payment Timing: Beginning vs. End of Period
                        </h3>
