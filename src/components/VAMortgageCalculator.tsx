...
import { ChevronDown, ChevronUp, RefreshCw, CheckCircle2, XCircle, RotateCcw } from 'lucide-react';
                ...
                <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm">
                    ...
                    {showAdvanced && (
                        <div className="space-y-4 pt-4 border-t border-gray-100 dark:border-gray-800 animate-in slide-in-from-top-2">
                            ...
                            <div>
                                <label className="block text-xs font-medium text-gray-500 mb-1">Property Tax ({currencySymbol}/mo)</label>
                                <CurrencyInput
                                    value={propertyTax}
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border border-blue-100 dark:border-blue-800">
                                ...
                                <p className="text-2xl font-bold text-blue-900 dark:text-blue-100">{currencySymbol}{result.totalMonthlyPayment.toLocaleString()}</p>
                            </div>
                            <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-xl border border-green-100 dark:border-green-800">
                                <p className="text-sm text-green-600 dark:text-green-400 mb-1">Total Loan Amount</p>
                                <p className="text-2xl font-bold text-green-900 dark:text-green-100">{currencySymbol}{result.totalLoanAmount.toLocaleString()}</p>
                                <p className="text-xs text-green-600/80 dark:text-green-400/80">
                                    Includes {currencySymbol}{result.fundingFeeAmount.toLocaleString()} Funding Fee
                                </p>
                            </div>
                            <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-xl border border-purple-100 dark:border-purple-800">
                                <p className="text-sm text-purple-600 dark:text-purple-400 mb-1">Total Interest</p>
                                <p className="text-2xl font-bold text-purple-900 dark:text-purple-100">{currencySymbol}{result.totalInterest.toLocaleString()}</p>
                            </div>
                            <div className="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-xl border border-orange-100 dark:border-orange-800">
                                <p className="text-sm text-orange-600 dark:text-orange-400 mb-1">VA Funding Fee</p>
                                <p className="text-2xl font-bold text-orange-900 dark:text-orange-100">{currencySymbol}{result.fundingFeeAmount.toLocaleString()}</p>
                            ...
                            <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-100 dark:border-gray-800">
                                ...
                                <div className="mb-6 w-full h-[300px]" role="img" aria-label="Pie chart showing monthly payment breakdown including principal, interest, taxes, insurance, and fees">
                                    <ChartBreakup
                                        ...
                                        legendType='none'
                                        centerLabel="Total"
                                        centerValue={`${currencySymbol}${result.totalMonthlyPayment.toLocaleString()}`}
                                        variant="donut"
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="flex justify-between items-center p-2 rounded-lg bg-green-50 dark:bg-green-900/20">
                                        ...
                                        <span className="text-sm font-bold text-gray-900 dark:text-gray-100">{currencySymbol}{result.monthlyTax.toLocaleString()}</span>
                                    </div>
