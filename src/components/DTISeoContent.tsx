            ...
            <section className="bg-purple-50 dark:bg-purple-900/10 rounded-2xl p-8 border border-purple-100 dark:border-purple-800">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 mt-6">
                    ...
                    <div className="text-gray-700 dark:text-gray-300 leading-relaxed">
                        <p><strong className="text-purple-600 dark:text-purple-400">Monthly gross income: {currencySymbol}6,000</strong></p>
                        <p>Housing costs: {currencySymbol}1,500 (mortgage, taxes, insurance)</p>
                        <p>Other debts: {currencySymbol}600 (car loan, credit cards)</p>
                        <br />
                        <p>Front-End DTI: {currencySymbol}1,500 ÷ {currencySymbol}6,000 = <strong>25%</strong> ✓</p>
                        <p>Back-End DTI: {currencySymbol}2,100 ÷ {currencySymbol}6,000 = <strong>35%</strong> ✓</p>
                        <br />
                        <p>This borrower qualifies for conventional financing (28/36 limits).</p>
                    </div>
                </div>
            </section>
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                            ...
                            the highest monthly payments first for maximum impact. Paying off a {currencySymbol}400/month car loan could
                            improve your DTI by 6-7 percentage points if you earn {currencySymbol}6,000/month. Even paying off small debts
                            helps—eliminating a {currencySymbol}100/month credit card payment still counts.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                            ...
                            received them consistently for 2+ years. A {currencySymbol}500/month income increase can improve DTI by 8-10
                            percentage points.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                            ...
                            term or securing a lower rate. Refinancing a {currencySymbol}20,000 car loan from 7% to 4% could save {currencySymbol}50-100/month.
            ...
            <section className="prose dark:prose-invert max-w-none">
                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                            It depends on your strategy. Paying off debt can improve DTI immediately—pay off a {currencySymbol}300/month
