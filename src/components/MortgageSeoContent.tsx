        ...
        <div className="max-w-4xl mx-auto mt-16 space-y-12">
            ...
            <section className="bg-blue-50 dark:bg-blue-900/10 rounded-2xl p-8 border border-blue-100 dark:border-blue-800">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 mt-6">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                        On a <strong className="text-blue-600 dark:text-blue-400">{currencySymbol}300,000 home</strong> with{' '}
                        <strong className="text-blue-600 dark:text-blue-400">20% down ({currencySymbol}60,000)</strong> at{' '}
                        ...
                        • Principal & Interest: <strong>{currencySymbol}1,517/month</strong><br />
                        • Property Taxes (1.2%): <strong>{currencySymbol}300/month</strong><br />
                        • Homeowners Insurance: <strong>{currencySymbol}100/month</strong><br />
                        • <strong className="text-blue-600 dark:text-blue-400">Total: {currencySymbol}1,917/month</strong>
                    </p>
                </div>
            </section>
            ...
            <section className="bg-green-50 dark:bg-green-900/10 rounded-2xl p-8 border border-green-100 dark:border-green-800">
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                            A jump from 680 to 740 credit score can lower your rate by 0.5-0.75%, saving you {currencySymbol}50,000+ over
                            30 years on a {currencySymbol}300,000 loan. Spend 6-12 months paying down debts, fixing credit report errors,
                    ...
                    <div>
                        ...
                        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                            PMI typically costs 0.5-1% of the loan amount annually ({currencySymbol}1,200-{currencySymbol}2,400/year on a {currencySymbol}240,000 loan).
                ...
                <div className="space-y-8">
                    <div>
                        ...
                        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                            ...
                            saving {currencySymbol}100,000+ compared to 30 years. You'll also get a lower interest rate (typically 0.5-0.75%
